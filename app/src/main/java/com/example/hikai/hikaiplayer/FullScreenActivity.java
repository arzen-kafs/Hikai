...
////                t.commit();
                ...
                Intent intent = new Intent(FullScreenActivity.this, com.example.hikai.hikaiplayer.Player.class);
    ...
    private void iniExoplayer(long seek,Uri videoUrl) {
        ...
        simpleExoPlayerFull.addListener(new Player.DefaultEventListener() {
            @Override
